    ...
    render: function() {
      ...
      if (
        ...
        children = children.concat(this.props.columns.map(function(column, i) {
          ...
          return <Td column={column} key={column.key} {...props}>{tdContents}</Td>;
        }.bind(this)));
      }
    ...
    render: function() {
      ...
      return (
        <tr className="reactable-filterer">
          <td colSpan={this.props.colSpan} tdDisplay={this.props.tdDisplay}>
    ...
    render: function() {
      ...
      if (this.data && typeof this.data.map === 'function') {
        ...
        children = children.concat(this.data.map(function(rawData, i) {
          ...
          return (
            <Tr columns={columns} key={i} data={data} className={this.props.trClassName} trProps={this.props.trProps} tdDisplay={this.props.tdDisplay} {...props}/>
          );
        }.bind(this)));
      }
