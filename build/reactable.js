    ...
    render: function() {
      ...
      if (
        ...
        children = children.concat(this.props.columns.map(function(column, i) {
          ...
          return React.createElement(Td, React.__spread({column: column, key: column.key},  props), tdContents);
        }.bind(this)));
      }
    ...
    render: function() {
      ...
      return (
        React.createElement("tr", {className: "reactable-filterer"}, 
          React.createElement("td", {colSpan: this.props.colSpan, tdDisplay: this.props.tdDisplay}, 
    ...
    render: function() {
      ...
      if (this.data && typeof this.data.map === 'function') {
        ...
        children = children.concat(this.data.map(function(rawData, i) {
          ...
          return (
            React.createElement(Tr, React.__spread({columns: columns, key: i, data: data, className: this.props.trClassName, trProps: this.props.trProps, tdDisplay: this.props.tdDisplay},  props))
          );
        }.bind(this)));
      }
